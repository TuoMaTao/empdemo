...
<div class="container">
    ...
    <div class="row body">
        <form class="form-horizontal" id="updateEmpFrom" action="${pageContext.request.contextPath}/emp/updateEmp" method="post">
    ...
    $(function(){
        ...
        $("#phone").blur(function(){
            ...
            if(reg.test(name)){
                ...
                $(".phone").attr("class","col-sm-6 pnone has-error");
                isPhone = false;
            }
        })
        //手机号校验，不能输入字母，一输入就没
